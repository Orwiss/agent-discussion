...
방금 나온 아이디어와 같은 방향을 반복하지 마세요. 매 발언마다 다른 사용자 상황이나 다른 각도를 꺼내세요.
참가자의 피드백은 최우선으로 반영하세요.{collab}""",
...
방금 나온 디자인 방향을 그대로 따라가지 마세요. 매 발언마다 다른 레퍼런스나 다른 감성 방향을 꺼내세요.
참가자의 피드백은 최우선으로 반영하세요.{collab}""",
        llm_config=llm_config,
        description=(
...
방금 나온 기술 방향을 그대로 이어받지 마세요. 매 발언마다 다른 기술 접근법이나 다른 트레이드오프를 꺼내세요.
참가자의 피드백은 최우선으로 반영하세요.{collab}""",
        llm_config=llm_config,
        description=(
